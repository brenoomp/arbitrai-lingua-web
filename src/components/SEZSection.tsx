            ...
            <div className="relative bg-gradient-to-br from-[#0A2240] to-[#1a365d] rounded-3xl p-8 overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-10">
                <div className="absolute inset-0" style={{
                  backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%2300C49A' fill-opacity='0.3'%3E%3Cpath d='M20 20l20-20H20v20z'/%3E%3C/g%3E%3C/svg%3E")`
                }}></div>
              </div>
            </div>
          </div>
